category: logging
priority: high
tags: api, authentication, authorization, cookie, encryption, express, go, injection, java, javascript, jwt, logging, mobile, owasp, password, php, rails, rest, rust, session, tls
