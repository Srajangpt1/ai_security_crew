category: database
priority: critical
tags: api, authentication, authorization, cookie, csrf, encryption, express, go, injection, java, javascript, laravel, oauth, owasp, password, php, rest, rust, session, xss
