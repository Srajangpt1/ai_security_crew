category: database
priority: critical
tags: api, authentication, authorization, aws, cookie, encryption, go, injection, ios, java, javascript, owasp, password, rails, rest, rust, secure_code_review, session, tls, xss
