...
from mcp_security_review.utils.env import is_env_truthy
...
try:
    __version__ = version("mcp-security-review")
...
@click.version_option(__version__, prog_name="mcp-security-review")
@click.command()
@click.option(
    "-v",
    "--verbose",
