...
MCP Atlassian includes a powerful security assessment tool that analyzes Jira tickets and generates security requirements for code generation. This ensures security considerations are built into your development process from the start.

**Key Features:**
- 🔍 **Automated Security Analysis** - Identifies security risks, technologies, and attack vectors
- 📋 **OWASP-Compliant Guidelines** - Provides specific security guidelines following industry best practices
- 🤖 **AI-Ready Prompt Injection** - Generates formatted security requirements for code generation prompts
- ⚡ **Risk Assessment** - Assigns risk levels (low/medium/high/critical) based on ticket content
- 🛡️ **Comprehensive Coverage** - Covers authentication, authorization, data validation, cryptography, and more

**Usage:**
```bash
# Assess a Jira ticket for security requirements
assess_ticket_security("PROJ-123")
```

**Integration with Code Generation:**
1. Run security assessment on your Jira ticket
