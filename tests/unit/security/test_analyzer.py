...
class TestSecurityAnalyzer:
    ...
    def test_identify_technologies(self) -> None:
        ...
        text_content = (
            "We need to implement this in Python using Django and PostgreSQL database"
        )
        ...
        )  # Django is detected as part of Python technology
        assert (
            "database" in technologies
        )  # PostgreSQL is detected as database technology
    ...
    def test_extract_text_content(self) -> None:
        ...
        ticket_data = {
            ...
            "fields": {"customfield_10001": "Custom field value"},
        }
    ...
    def test_analyze_ticket_minimal_data(self) -> None:
        ...
        ticket_data = {"summary": "Update documentation"}
