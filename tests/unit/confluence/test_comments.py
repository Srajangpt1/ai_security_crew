...
from mcp_security_review.providers.atlassian.confluence.comments import CommentsMixin
...
class TestCommentsMixin:
    ...
    def comments_mixin(self, confluence_client):
        ...
        with patch(
            "mcp_security_review.providers.atlassian.confluence.comments.ConfluenceClient.__init__"
        ) as mock_init:
