...
@patch("mcp_security_review.utils.oauth.BYOAccessTokenOAuthConfig.from_env")
@patch("mcp_security_review.utils.oauth.OAuthConfig.from_env")
...
@patch("mcp_security_review.utils.oauth.logger")
